...
const handlers = {
  ...
  "markkantlinje": (f, r, mode) => mode <= 1 ? new Style({ zIndex: 2, stroke: getStroke("#00a6ff", 1) }) : null,
  "kurvighet": (f, r, mode) => mode == 0 ? new Style({ zIndex: 2, stroke: getStroke("#df006840", 12) }) : null,
  "hojdlinje": (feature, r, mode) => mode == 0 ? new Style({ stroke: getStroke("rgba(150, 127, 105, 1)", feature.get("stodkurva") == "Ja" ? 1 : 0.5) }) : null,
  "ledningslinje": () => new Style({ stroke: getStroke("#000000", 1) }),
